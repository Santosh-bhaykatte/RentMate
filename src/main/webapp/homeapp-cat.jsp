		...
		<div class="row g-4">
				...
				<div class="product-card">
					...
					<div class="product-details" style="text-align: center;">
						<h5 class="product-title">
							<a href="details?itemId=${item.id}">Mist Fan</a>
						</h5>
			...
			<div class="col-md-3">
				<div class="product-card">
					...
					<div class="product-details" style="text-align: center;">
						<h5 class="product-title">
							<a href="details?itemId=${item.id}">Projector with Screen</a>
						</h5>
			...
			<div class="col-md-3">
				<div class="product-card">
					...
					<div class="product-details" style="text-align: center;">
						<h5 class="product-title">
							<a href="details?itemId=${item.id}">Room Oil Heater</a>
						</h5>
			...
			<div class="col-md-3">
				<div class="product-card">
					...
					<div class="product-details" style="text-align: center;">
						<h5 class="product-title">
							<a href="details?itemId=${item.id}">Air Purifier & Geyser
								Combo</a>
						</h5>
			...
			<div class="col-md-3">
				<div class="product-card">
					...
					<div class="product-details" style="text-align: center;">
						<h5 class="product-title">
							<a href="details?itemId=${item.id}">OTG</a>
						</h5>
			...
			<div class="col-md-3">
				<div class="product-card">
					...
					<div class="product-details" style="text-align: center;">
						<h5 class="product-title">
							<a href="details?itemId=${item.id}">Kitchen Combo Deal of 4</a>
						</h5>
			...
			<div class="col-md-3">
				<div class="product-card">
					...
					<div class="product-details" style="text-align: center;">
						<h5 class="product-title">
							<a href="details?itemId=${item.id}">100 Litre Deep Freezer</a>
						</h5>
			...
			<div class="col-md-3">
				<div class="product-card">
					...
					<div class="product-details" style="text-align: center;">
						<h5 class="product-title">
							<a href="details?itemId=${item.id}">Induction Cooktop</a>
						</h5>
			...
			<div class="col-md-3">
				<div class="product-card">
					...
					<div class="product-details" style="text-align: center;">
						<h5 class="product-title">
							<a href="details?itemId=${item.id}">Inverter - Single Battery</a>
						</h5>
			...
			<div class="col-md-3">
				<div class="product-card">
					...
					<div class="product-details" style="text-align: center;">
						<h5 class="product-title">
							<a href="details?itemId=${item.id}">Dishwasher - 12 P</a>
						</h5>
						<p class="product-price">&#8377;1,499/ Month</p>
						<a href="details?itemId=${item.id}" class="btn btn-rent">Take
							On Rent</a>
			...
			<div class="col-md-3">
				<div class="product-card">
					...
					<div class="product-details" style="text-align: center;">
						<h5 class="product-title">
							<a href="details?itemId=${item.id}">2 Ton Split Air
								Conditioner</a>
						</h5>
			...
			<div class="col-md-3">
				<div class="product-card">
					...
					<div class="product-details" style="text-align: center;">
						<h5 class="product-title">
							<a href="details?itemId=${item.id}">Refrigerator Double Door</a>
						</h5>
			...
			<div class="col-md-3">
				<div class="product-card">
					...
					<div class="product-details" style="text-align: center;">
						<h5 class="product-title">
							<a href="details?itemId=${item.id}">Front Loading Washing
								Machine</a>
						</h5>
			...
			<div class="col-md-3">
				<div class="product-card">
					...
					<div class="product-details" style="text-align: center;">
						<h5 class="product-title">
							<a href="details?itemId=${item.id}">Coolers</a>
						</h5>
			...
			<div class="col-md-3">
				<div class="product-card">
					...
					<div class="product-details" style="text-align: center;">
						<h5 class="product-title">
							<a href="details?itemId=${item.id}">Television 50-55" (Inch)</a>
						</h5>
